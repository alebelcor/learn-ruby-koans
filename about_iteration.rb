...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # ANSWER: It's the equivalent of Array#reduce. A method to iterate over the
    # elements on the array, given a starting value, in which a calculated value
    # will be carried along throughout each iteration.
  end
  ...
  #   # code to read 'file'
  #
  # ANSWER: Maybe by doing it this way we don't need to close the opened file?
