...
class AboutBlocks < Neo::Koan
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    result = method_with_block_arguments(&make_upper) # TODO: Need to take another look at this
  ...
  def test_methods_can_take_an_explicit_block_argument
    ...
    add_one = lambda { |n| n + 1 }
    assert_equal 11, method_with_explicit_block(&add_one) # TODO: Need to take another look at this
  end
