...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_slash_b_anchors_to_a_word_boundary
    assert_equal "vines", "bovine vines"[/\bvine./] # TODO: I don't follow
  end
  ...
  def test_sub_is_like_find_and_replace
    assert_equal "one t-three", "one two-three".sub(/(t\w*)/) { $1[0, 1] } # TODO: Kind of confusing, but I think I got it
  end

  def test_gsub_is_like_find_and_replace_all
    assert_equal "one t-t", "one two-three".gsub(/(t\w*)/) { $1[0, 1] } # TODO: Kind of confusing, but I think I got it
  end
end
